...
1. Make an [Issue](https://github.com/studio23/https://github.com/Studio-23-xyz/SettingsManager/issues/new)
...
```json
    {
        "dependencies": {
            "com.studio23.https://github.com/Studio-23-xyz/SettingsManager": "https://github.com/YOUR_USER/https://github.com/Studio-23-xyz/SettingsManager.git"
        }
    }
```
...
reported to the community leaders responsible for enforcement at support@studio-23.xyz.
